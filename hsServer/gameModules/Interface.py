...
class Filter:
    ...
    def __init__(self):
        ...
        self.Cards = set(Minion.__subclasses__()+Spell.__subclasses__()+Weapon.__subclasses__()+Hero.__subclasses__())^set(Derive._subclasses__())
...
Professions = [Druid, Hunter, Mage, Paladin,
